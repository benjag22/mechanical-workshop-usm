...
public record CreateWorkOrderRealizedServiceResponse(
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "ID del registro")
        int id,

        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "ID del work order asociado")
        int workOrderId,

        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "ID del work service asociado")
        int workServiceId,
